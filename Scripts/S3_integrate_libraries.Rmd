...
```{r}
naive <- readRDS("robjects/cellbender_CCregressed_D13_D33_D45_D47_CD4_Naive_custom_cellSNP__nF_500_1200_nC_1200_post_demultiplexed_full_processed.rds")
...
```{r}
saveRDS(merge_all_libs, file = "robjects/naive_merged_with_integrated_proliferated_L1_L2_custom_naive_cellsnp.rds")
```
