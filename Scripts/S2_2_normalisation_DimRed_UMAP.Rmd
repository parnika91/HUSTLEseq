...
saveRDS(hustle, file = paste0("robjects/cellbender_CCregressed_", lib_name, "_custom_cellSNP_nF_", deadcell_nF_lowercutoff, "_", deadcell_nF_uppercutoff, "_nC_",deadcell_nC_lowercutoff,"_post_demultiplexed_full_processed.rds"))
